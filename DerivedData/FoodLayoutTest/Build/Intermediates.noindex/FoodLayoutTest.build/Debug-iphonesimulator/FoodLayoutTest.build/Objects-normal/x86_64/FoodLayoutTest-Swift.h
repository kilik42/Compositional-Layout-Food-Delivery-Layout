...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FoodLayoutTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14FoodLayoutTest11AppDelegate")
...
SWIFT_CLASS("_TtC14FoodLayoutTest40FoodControllerVCCollectionViewController")
@interface FoodControllerVCCollectionViewController : UICollectionViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC14FoodLayoutTest13SceneDelegate")
...
SWIFT_CLASS("_TtC14FoodLayoutTest14ViewController")
